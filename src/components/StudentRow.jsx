export default function StudentRow({ student, onDelete, onEdit }) {
  return (
    <div className="grid grid-cols-12 gap-4 px-6 py-4 hover:bg-gray-50 transition-colors items-center">
      <div className="col-span-2 flex items-center gap-3">
        <img src={student.avatar} alt="avatar" className="w-10 h-10 rounded-lg object-cover" />
      ...
      <div className="col-span-2 text-gray-600 text-sm">{student.enrollNumber}</div>
      <div className="col-span-2 text-gray-600 text-sm">{student.dateOfAdmission}</div>
