  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-4">
      <div className="flex gap-4">
        <img src={student.avatar} alt={student.name} className="w-16 h-16 rounded-lg object-cover" />
        <div className="flex-1">
          ...
          <div className="space-y-1 text-sm">
            ...
            <p><span className="text-gray-500">Enroll:</span> {student.enrollNumber}</p>
            <p><span className="text-gray-500">Date:</span> {student.dateOfAdmission}</p>
          </div>
        </div>
      </div>
